...
execute_process(COMMAND ${CMAKE_C_COMPILER} -print-sysroot OUTPUT_VARIABLE _arm_sysroot
...
# We provide our own syscall stubs, so try_compile must not try to link a full executable (the standard library link
# would fail at configure time).
